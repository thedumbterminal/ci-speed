...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('test_run', sa.Column('project_id', sa.INTEGER(), autoincrement=False, nullable=False))
    op.drop_constraint(None, 'test_run', type_='foreignkey')
    op.create_foreign_key('test_run_project_id_fkey', 'test_run', 'project', ['project_id'], ['id'])
